...
Функция СформироватьСписокРеализации(Выборка)        
	...
	Пока Выборка.Следующий() Цикл
		...
		Если Не ЗначениеЗаполнено(Выборка.Реализация) Тогда 
			...
			НоваяРеализация.ВКМ_ВыполнитьАвтозаполнение(); // Выборка.Договор (М.С. зам. 16.02.- п1. не нужно и так работает) 
			Если НоваяРеализация.ПроверитьЗаполнение() Тогда  // М.С. зам. 16.02 - п 4. 
